		...
		<div>
			<div class="col-sm-11">
			 		<div class="col-sm-12">
				      <div class="col-sm-3">
				      <div>
				      <input type="hidden" value="account_seq" name="account_seq">
				      </div>
				...
				<div class="col-sm-12">  <label for="disabledInput" class="col-sm-12 control-label"> </label></div>
			 		<div class="col-sm-12">
				      ...
				      <div class="col-sm-3">
				       	 <input class="form-contro col-sm-2"  id="transactionDate" name="transactionDate"
				       	  type="text" value="" style="width: 80%" title="거래일자">
				      </div>
			 		</div>
					<div class="col-md-offset-4">
					<div class="col-sm-12"><label for="disabledInput" class="col-sm-12 control-label"></label></div>
					<button class="btn btn-primary" onClick='fn_addtoBoard()'>등록</button>
					<div class="col-sm-12"><label for="disabledInput" class="col-sm-12 control-label"></label></div>
...
function fn_addtoBoard(){
    ...
    form.action = "<c:url value='/account/accountInsertPro.do'/>";
    form.submit();
